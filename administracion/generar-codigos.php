...
include('load/generar-codigos.php');
						...
						<div class="col-md-12 col-lg-12 col-xl-12 col-xs-12">
                                ...
                                <div class="row">
	                                <div class="col-md-3">
	                                  <div class="col-md-6" style="margin-left:-15px;">
		                                  <div class="form-group">
		                                     ...
		                                     <input type="button" class="form-control" value="Generar" onclick="realizaProceso();">
		                                  </div>
	                                 </div>
	                                  <div class="col-md-6" >
		                                  <div class="form-group">
                                 ...
                                 <div class="col-md-3">
                                  <div class="form-group">
                                    ...
                                    <? 
									   while($producto=$stmt1->fetch(PDO::FETCH_ASSOC)){
									?>	
                                 ...
                                 <div class="col-md-3">
                                  <div class="form-group">
                                     ...
                                     <input type="date" class="form-control" name="f_creacion" id="f_creacion">
                                  </div>
                                 </div>
                            ...
                            <section class="panel">
                                ...
                                <table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
                                    <? while($codigos=$stmt0->fetch(PDO::FETCH_ASSOC)){ ?>
										<tr>
											<td><? echo $codigos['codigo']; ?></td>
											<td><? echo $codigos['PRODUCTO_NOM']; ?></td>
											<td><? echo $codigos['CLIENTE_NOM']; ?></td>
											<td><? echo $codigos['idUsuario']; ?></td>
											<td><? echo $codigos['idVenta']; ?></td>
                                            <td><? echo $codigos['fechaCreacion']; ?></td>
                                            <td><? echo $codigos['fechaActivacion']; ?></td>
                                            <td><? echo $codigos['fechaVencimiento']; ?></td>
                                            <td><? echo $codigos['fechaCobro']; ?></td>
                                            <td><? echo $codigos['estado']; ?></td>
...
<script>
	...
	function realizaProceso(){
		var cantidad = $("#cantidad").val();
	        ...
	        $.ajax({
	                data:  parametros,
	                url:   'actions/agregar-codigo.php',
	                type:  'POST',
	                beforeSend: function () {
	                 $("#codigo").html("Procesando, espere por favor...");
	                },
