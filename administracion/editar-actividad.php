						...
						<div class="col-md-12 col-lg-12 col-xl-12 col-xs-12">
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Editar Actividad <? echo $actividadE['nombre']; ?></h2>
								</header>
								<div class="panel-body">
                                
                                <form id="agregar-horario" action="actions/editar-actividad.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="ida" id="ida" value="<? echo $actividadE['id']; ?>">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" name="nombre" id="nombre" value="<? echo $actividadE['nombre']; ?>">
                                  </div>
                                 </div>
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <option value="<? echo $actividadE['idColaborador']; ?>"><? $queryc="SELECT nombre FROM colaboradores WHERE id=:id";
                                            $stmtc= $db->prepare($queryc);
											$stmtc->bindParam(':id', $actividadE['idColaborador']);
                                            if(!$stmtc->execute()){echo "error queryc";}
											$comunac=$stmtc->fetch(PDO::FETCH_ASSOC);
											echo $comunac['nombre']; ?></option>
                                      <? 
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <option value="<? echo $actividadE['idProducto']; ?>"><? $queryc="SELECT nombre FROM productos WHERE id=:id";
                                            $stmtc= $db->prepare($queryc);
											$stmtc->bindParam(':id', $actividadE['idProducto']);
                                            if(!$stmtc->execute()){echo "error queryc";}
											$comunac=$stmtc->fetch(PDO::FETCH_ASSOC);
											echo $comunac['nombre']; ?></option>
                                      <? 
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <input type="number" class="form-control" name="costo" id="costo" value="<? echo $actividadE['costo']; ?>">
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" name="direccion" id="direccion" value="<? echo $actividadE['direccion']; ?>">
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <option value="<? echo $actividadE['comuna']; ?>"><? $queryc="SELECT COMUNA_NOMBRE FROM comuna WHERE COMUNA_ID=:id";
                                            $stmtc= $db->prepare($queryc);
											$stmtc->bindParam(':id', $actividadE['comuna']);
                                            if(!$stmtc->execute()){echo "error queryc";}
											$comunac=$stmtc->fetch(PDO::FETCH_ASSOC);
											echo $comunac['COMUNA_NOMBRE'];  ?></option>
                                      <? 
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" name="telefono" id="telefono" value="<? echo $actividadE['telefono']; ?>">
                                  </div>
                                 </div>
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" name="email" id="email" value="<? echo $actividadE['email']; ?>">
                                  </div>
                                 </div>
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <input type="hidden" name="fotoA" id="fotoA" value="<? echo $actividadE['foto']; ?>">
                                     <img src="../img/actividades/<? echo $actividadE['foto']; ?>" class="img-responsive">
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                     ...
                                     <select class="form-control" name="estado">
                                      <? if($actividadE['estado']==1){ ?>
                                      <option value="1">Activo</option>
                                      <option value="2">Inactivo</option>
                                      <? }elseif($actividadE['estado']==2){ ?>
                                      <option value="2">Inactivo</option>
                                      <option value="1">Activo</option>
                                      <? } ?>
                                     </select>  
                                ...
                                <table class="table table-bordered table-striped mb-none" id="datatable-default">
                                    ...
                                    <? while($actividad=$stmt0->fetch(PDO::FETCH_ASSOC)){ ?>
										<tr>
											...
											<td><? $queryc="SELECT COMUNA_NOMBRE FROM comuna WHERE COMUNA_ID=:id";
                                            $stmtc= $db->prepare($queryc);
											$stmtc->bindParam(':id', $actividad['comuna']);
                                            if(!$stmtc->execute()){echo "error queryc";}
											$comunac=$stmtc->fetch(PDO::FETCH_ASSOC);
											echo $comunac['COMUNA_NOMBRE']; ?></td>
                                            <td><? echo $actividad['telefono']; ?></td>
                                            <td><? echo $actividad['email']; ?></td>
                                            <td>$ <? 
