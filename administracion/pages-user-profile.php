                                ...
                                <div class="panel panel-accordion panel-accordion-primary">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapse0One">
											  Información
											</a>
										</h4>
									</div>
									<div id="collapse0One" class="accordion-body collapse in">
										<div class="panel-body">
										  <div class="col-md-12">
                                             <form action="actions/edit_profile.php" method="post">
                                             <input type="hidden" name="id" value="<? echo $row['id']; ?>">
                                             <input type="hidden" name="page" value="pages-user-profile">
                                              <div class="form-group">
												<label class="col-md-3 control-label" for="user">Usuario</label>
												<div class="col-md-9">
													<input type="text" class="form-control" required name="user" value="<? echo $row['user_cc']; ?>">
												</div>
											</div>
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="mail">Email</label>
												<div class="col-md-9">
													<input type="text" class="form-control" required name="mail" value="<? echo $row['mail_cc']; ?>">
												</div>
											</div>
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="pass">Clave</label>
												<div class="col-md-9">
													<textarea rows="1" class="form-control" required name="pass"><? echo $row['pass_cc']; ?></textarea>
												</div>
											</div>
                                            <div class="form-group">
