...
<html class="fixed sidebar-left-collapsed">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="assets/stylesheets/bootstrap-duallistbox.css">
                    ...
                    <!-- ACCORDION -->
						...
						<div class="col-md-12 col-lg-12 col-xl-12 col-xs-12">
								...
								<header class="panel-heading">
									...
									<h2 class="panel-title">Crear paquetes</h2>
								</header>
                            ...
                            <section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Editar Paquetes</h2>
								</header>
								<div class="panel-body">
...
<?php 
		...
		<?php echo $new = $key["idActividades"]."_".$key["categoria_id"];

		if ($new != $old){ ?> 
			<td rowspan="<?php echo $arreglo[ "cantidad" ][ $key[ "idActividades" ] ][ $key[ "categoria_id" ] ] ?>"><?php echo $key['NomActiv']; ?> </td>
		<?php 
 			}
		$old = $new; ?>
		<td><?php echo $key['NomCa']; ?> </td>
		<td><a href=#.php?id="<?php echo $key['actividad_id']; ?>"><i class='fa fa-pencil'></i></a></td>
		</tr> 
<?php
 } 
}
?> 
    	...
    	<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js"></script>
   		 <script src="assets/javascripts/jquery.bootstrap-duallistbox.js"></script>
   		 <script>
